...
{
    private static Z80_SNAPSHOT snapshot = new Z80_SNAPSHOT();
    ...
    public static Z80_SNAPSHOT LoadZ80(System.IO.Stream fs)
    {
        ...
        for (int ramBankIndex = 0; ramBankIndex < 16; ++ramBankIndex)
        {
            snapshot.RAM_BANK[ramBankIndex].Initialize(); // TODO verify this zeros the array
        }
