...
public class BasicSample : MonoBehaviour {
    ...
    void OnGUI() {
        ...
        var guiScale = new Vector3(Screen.width, Screen.height, 1.0f);
        ...
        if (GUILayout.Button("Select Games Root Folder")) {
            var paths = StandaloneFileBrowser.OpenFolderPanel("Select Games Root Folder", "", true);
            WriteResult(paths);
        }
        //GUILayout.Space(5);
        ...
        //if (GUILayout.Button("Install JPLaunch!")) {
